...
/** @type {string} */
const CACHE_VERSION = '1727461058|904388036';
/** @type {string} */
const CACHE_PREFIX = 'godot-test-html--sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'godot-test-html-export.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["godot-test-html-export.html","godot-test-html-export.js","godot-test-html-export.offline.html","godot-test-html-export.icon.png","godot-test-html-export.apple-touch-icon.png","godot-test-html-export.worker.js","godot-test-html-export.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["godot-test-html-export.wasm","godot-test-html-export.pck","godot-test-html-export.side.wasm"];
