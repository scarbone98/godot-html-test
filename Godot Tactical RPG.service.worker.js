...
/** @type {string} */
const CACHE_VERSION = '1727462280|226277542';
/** @type {string} */
const CACHE_PREFIX = 'Godot Tactical R-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Godot Tactical RPG.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Godot Tactical RPG.html","Godot Tactical RPG.js","Godot Tactical RPG.offline.html","Godot Tactical RPG.icon.png","Godot Tactical RPG.apple-touch-icon.png","Godot Tactical RPG.worker.js","Godot Tactical RPG.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Godot Tactical RPG.wasm","Godot Tactical RPG.pck"];
